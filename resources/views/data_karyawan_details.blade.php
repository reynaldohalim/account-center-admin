        ...
        <div class="row gy-4 col-12">
            <div class="card widget-card border-light shadow-sm">
                <div class="card-body">
                    ...
                    <p class="text-center text-secondary mb-2">{{$dataPekerjaan->divisi}} {{$dataPekerjaan->jabatan}}</p>
                </div>
            </div>
        </div>
        <br>
                ...
                <ul class="nav nav-tabs" id="tablist" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="absensi-tab" data-bs-toggle="tab"
                            data-bs-target="#absensi-tab-pane" type="button" role="tab" aria-controls="absensi-tab-pane"
                            aria-selected="false">Absensi</button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="izin-tab" data-bs-toggle="tab" data-bs-target="#izin-tab-pane"
                            type="button" role="tab" aria-controls="izin-tab-pane" aria-selected="false">Izin</button>
                    </li>
                </ul>
                    ...
                    <div class="tab-pane show active" id="datapribadi-tab-pane" role="tabpanel"
                        ...
                        {{-- <form action="#!" class="row gy-3 gy-xxl-4">
                            <div class="col-12 col-md-6">
                                ...
                                <input type="text" class="form-control" id="input" value="{{$dataPribadi->nama}}">
                            </div>
                            <div class="col-12 col-md-6">
                                <label for="" class="form-label">Jenis Kelamin</label>
                                <select class="form-control">
                                    <option value="l" @php if ($dataPribadi->jenis_kelamin == 'l') echo 'selected' @endphp>Laki-laki</option>
                                    <option value="p" @php if ($dataPribadi->jenis_kelamin == 'p') echo 'selected' @endphp>Perempuan</option>
                                </select>
                            </div>
                            <div class="col-12">
                                <label for="" class="form-label">Alamat KTP</label> <i class="fas fa-exclamation-triangle warning-icon" onclick="showWarning('{{$dataPribadi->nama}}', 'newData')"></i>
                            ...
                            <div class="col-12 col-md-6">
                                ...
                                <input type="text" class="form-control" id="input" value="{{$dataPribadi->no_hp}}">
                            </div>
                            <div class="col-12 col-md-6">
                                <label for="" class="form-label">Tempat Lahir</label>
                                <input type="text" class="form-control" id="input" value="{{$dataPribadi->tempat_lahir}}">
                            </div>
                            <div class="col-12 col-md-6">
                            ...
                            <div class="col-12 col-md-6">
                                ...
                                <select class="form-control">
                                    <option value="Islam" @php if ($dataPribadi->agama == 'Islam') echo 'selected' @endphp>Islam</option>
                                    <option value="Kristen" @php if ($dataPribadi->agama == 'Kristen') echo 'selected' @endphp>Kristen</option>
                                    <option value="Katolik" @php if ($dataPribadi->agama == 'Katolik') echo 'selected' @endphp>Katolik</option>
                                    <option value="Buddha" @php if ($dataPribadi->agama == 'Buddha') echo 'selected' @endphp>Buddha</option>
                                    <option value="Hindu" @php if ($dataPribadi->agama == 'Hindu') echo 'selected' @endphp>Hindu</option>
                                    <option value="Konghucu" @php if ($dataPribadi->agama == 'Konghucu') echo 'selected' @endphp>Konghucu</option>
                                </select>
                            </div>
                            <div class="col-12 col-md-6">
                                <label for="" class="form-label">Status Nikah</label>
                                <select class="form-control">
                                    <option value="0" @php if ($dataPribadi->status_nikah == '0') echo 'selected' @endphp>Belum kawin</option>
                                    <option value="1" @php if ($dataPribadi->status_nikah == '1') echo 'selected' @endphp>Kawin</option>
                                </select>
                            </div>
                            <div class="col-12 col-md-6">
                                <label for="" class="form-label">Jumlah Anak</label>
                                <input type="text" class="form-control" id="input" value="{{$dataPribadi->jumlah_anak}}">
                            </div>
                            <div class="col-12 col-md-6">
                                <label for="" class="form-label">Status PPh21</label>
                                <input type="text" class="form-control" id="input" value="{{$dataPribadi->status_pph21}}">
                            </div>
                            <div class="col-12 col-md-6">
                                <label for="" class="form-label">Pendidikan Terakhir</label>
                                <input type="text" class="form-control" id="input" value="{{$dataPribadi->pendidikan_terakhir}}">
                            </div>
                            <div class="col-12">
                        ...
                        <form action="#!" class="row gy-3 gy-xxl-4">
                            ...
                            @foreach($labels as $field => $label)
                                <div class="col-12 @if(in_array($field, ['nama', 'jenis_kelamin', 'no_hp', 'tempat_lahir', 'tgl_lahir', 'agama', 'status_nikah', 'jumlah_anak', 'status_pph21', 'pendidikan_terakhir'])) col-md-6 @endif">
                                    <label for="" class="form-label">{{ $label }}</label>
                                    @php
                                        $pembaruan = $pembaruanData->firstWhere('label', $field);
                                    @endphp
                                    @if($pembaruan)
                                        <i class="fas fa-exclamation-triangle warning-icon" data-bs-toggle="modal" data-bs-target="#pembaruanModal-{{ $pembaruan->id }}"></i>
                                    @endif
                                    ...
                                    @else
                                        <input type="text" class="form-control" id="input" value="{{ $dataPribadi->$field }}">
                                    @endif
                                </div>
                            @endforeach
...
<div class="modal fade" id="pembaruanModal-{{ $pembaruan->id }}" tabindex="-1" aria-labelledby="pembaruanModalLabel-{{ $pembaruan->id }}" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="pembaruanModalLabel-{{ $pembaruan->id }}">Pembaruan Data - {{ $pembaruan->label }}</h5>
...
@endforeach
                                ...
                                <div class="card-body">
                                    <form action="#!" class="row gy-3 gy-xxl-4">
                                        <div class="col-12 col-md-6">
                                            ...
                                            <input type="text" class="form-control" id="name{{$keluarga->id}}" value="{{$keluarga->nama}}">
                                        </div>
                                        <div class="col-12 col-md-6">
                                            <label for="relationship{{$keluarga->id}}" class="form-label">Hubungan</label>
                                            <input type="text" class="form-control" id="relationship{{$keluarga->id}}" value="{{$keluarga->hubungan}}">
                                        </div>
                    ...
                    <div class="tab-pane fade" id="pendidikan-tab-pane" role="tabpanel" aria-labelledby="pendidikan-tab"
                        tabindex="0">
                    ...
                    <div class="tab-pane fade" id="organisasi-tab-pane" role="tabpanel" aria-labelledby="organisasi-tab"
                        tabindex="0">
                        <div class="card accordion" id="accordionExample">
                            <div class="card-header" id="headingOne">
                                <h2 class="mb-0">
